...
ActiveRecord::Schema.define(version: 2022_08_03_055752) do
  ...
  create_table "shopping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shopping_id"], name: "index_shopping_addresses_on_shopping_id"
  end
  ...
  add_foreign_key "shopping_addresses", "shoppings"
